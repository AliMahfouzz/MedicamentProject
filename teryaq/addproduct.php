...
if (isset($_POST["submit"])) {
    ...
    $query = "insert into product (pname,pdescription,ptype,pcategory,pprice,pimage,idpharmacy) values ('$productname','$productdescription','$producttype','$productcategory','$productprice','$profile_pic','$idpharmacy')";
    $result = mysqli_query($con, $query);

    if ($result) {
        $_SESSION['product_message'] = 'Your medication product is registered successfully';
        header('Location: addproduct.php');
    } else {
        $_SESSION['product_message'] = 'Your mediaction product is not registered, try again !!!!';
        header('Location: addproduct.php');
    }
    ...
    <div class="site-wrap">
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="h3 mb-5 text-black">Add Medication Product</h2>
                    </div>
                    <div class="col-md-12">
                        <?php
                        ...
                        <form method="POST" action="addproduct.php" enctype="multipart/form-data">
                            <div class="p-3 p-lg-5 border">
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label for="pname" class="text-black">Product Name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="pname" name="pname">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="pdescription" class="text-black">Product Description <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="pdescription" name="pdescription">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label for="pimage" class="text-black">Product image <span class="text-danger">*</span></label>
                                        <input type="file" class="form-control" id="fileToUpload" name="fileToUpload" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label for="pcategory" class="text-black">Product Category </label>
                                        <select class="form-control" id="pcategory" name="pcategory">
                                            <option>Drugs</option>
                                            <option>Supplements</option>
                                            <option>Vitamins</option>
                                            <option>Proteins Supplements</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="ptype" class="text-black">Product Type </label>
                                        <input type="text" class="form-control" id="ptype" name="ptype">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label for="pprice" class="text-black">Product price </label>
                                        <input type="number" step="any" class="form-control" id="pprice" name="pprice">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input type="submit" name="submit" class="btn btn-primary btn-lg btn-block" value="Add product">
                                    </div>
                                </div>
                            </div>
                        </form>
