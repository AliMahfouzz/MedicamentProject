    ...
    <div class="site-navbar py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    ...
                    <li class="has-children">
                      <a href="#">Vitamins</a>
                      <ul class="dropdown">
                        <li><a href="#">Proteins Supplements</a></li>
          ...
          <div class="icons">
            <a href="#" class="icons-btn d-inline-block js-search-open"><span>Login</span></a>
            <a href="#" class="icons-btn d-inline-block js-search-open ml-1"><span>Register</span></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <p>
              ...
              Copyright &copy;
              <script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="#" target="_blank"
                class="text-primary">EL-TreaQ</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
